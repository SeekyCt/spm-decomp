...
config.libs = [
    Dol(
        ...
        Object(Matching, "mot_walk.c", postprocess="tools/export_movement_constants.py"),
        Object(Matching, "mario_pouch.c"),
        Object(NonMatching, "mario.c", postprocess="tools/fixup_mario.py"),
        Object(Matching, "mario_motion.c"),
        Object(Matching, "mario_move.c", postprocess="tools/export_movement_constants.py"),
